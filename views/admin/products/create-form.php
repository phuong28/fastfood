                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="<?php echo url("admin/products/create") ?>" method="POST" enctype="multipart/form-data" style="text-align:center">
                            <div class="row mb-3">
                                    <label for="name" class="col-sm-2 col-form-label">Món ăn</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label for="rate" class="col-sm-2 col-form-label">Số xuất</label>
                                    <div class="col-sm-10">
                                        <input type="number" step="1" class="form-control" id="rate" name="quantity">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="price" class="col-sm-2 col-form-label">Giá 1 suất</label>
                                    <div class="col-sm-10">
