                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <h3 class="mb-4 mt-4">Danh sách đặt hàng</h3>
                                        ...
                                        <?php foreach($orders as $order): ?>
                                            <tr>
                                                ...
                                                <?php if($order['status']==0): ?>
                                                    <td>
                                                        <a href="<?php echo url("admin/orders/watingSuccess", ['id' => $order['order_id']]) ?>"><button class="btn btn-sm btn-warning">Xác nhận đơn</button></a>
                                                    </td>
                                                <?php endif ?>
                                            </tr>
                                        <?php endforeach ?>
